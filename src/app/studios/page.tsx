...
export default function StudiosPage() {
  ...
  const hasStudioMembership = memberships.some(m => m.type === 'studio' && m.active);

  useEffect(() => {
    const loadProducts = async () => {
      try {
        const allProducts = await getMembershipProducts();
        // Filter for studio membership products
        const studioProducts = allProducts
          .filter(p => p.tags.some(tag => tag.toLowerCase().includes('studio')))
          .map(p => ({
            id: p.id,
            title: p.title,
    ...
    <div className="min-h-screen bg-white text-black pb-20">
      ...
      <div className="container mx-auto px-4 pt-32">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold mb-6">Studio Space Membership</h2>
          <p className="text-xl text-gray-700 leading-relaxed">
            Access private studio space with 24/7 availability, high ceilings, 
            natural light, and all the amenities you need to create.
          </p>
        </div>

        {/* Membership Status */}
        {isAuthenticated && hasStudioMembership && (
          <div className="max-w-2xl mx-auto mb-12 p-6 bg-green-50 border-2 border-green-500 rounded-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-green-700">You have active access to studio space.</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="max-w-4xl mx-auto mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              ...
              <h4 className="font-bold mb-2">Private Space</h4>
              <p className="text-sm text-gray-600">Dedicated studio area for your work</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-sm text-gray-600">Work on your schedule anytime</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-bold mb-2">Full Amenities</h4>
              <p className="text-sm text-gray-600">WiFi, utilities, and basic equipment</p>
            </div>
          </div>
        </div>
      </div>
